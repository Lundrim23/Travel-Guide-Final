  ...
  return (
    <>
      ...
      <div class="mx-auto flex w-96 flex-col bg-white rounded-2xl shadow-xl shadow-slate-300/60 mb-10 mr-10 mt-20">
        ...
        />
        <div class="p-4">
          <small class="text-pink-500 text-xs">{post.address}</small>
          ...
          <button onClick={() => likeEvent(post._id)} class=" ml-52 hover:bg-slate-100  hover:ring hover:ring-rose-400 hover:p-1" >
          <FaThumbsUp color="#f43f5e" icon="fa-solid FaThumbsUp" class=""  />
          </button> 
          <button onClick={() => unlikeEvenet(post._id)} class="ml-3 hover:bg-slate-100 hover:ring hover:ring-violet-300 hover:p-1">
