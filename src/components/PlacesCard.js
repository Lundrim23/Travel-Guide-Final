  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        title="more about"
        class="w-full order-first py-2 px-3 ml-2 mb-2 text-center rounded-xl bg-gray-100 transition hover:bg-gray-200 active:bg-gray-300 focus:bg-gray-200 sm:w-max"
      >
