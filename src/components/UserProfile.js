...
<div className="relative max-w-md mx-auto lg:max-w-screen-xl md:max-w-2xl mt-6 min-w-0 break-words bg-stone-100 w-full mb-6 shadow-lg rounded-xl mt-40 mb-40">
    <div className="px-6">
        ...
        <div className="text-center mt-2">
            <h3 className="text-2xl text-slate-700 font-bold leading-normal mb-1">Name Name</h3>
            <p className="text-s text-slate-700 font-bold leading-normal mb-1">NameJ@gmail.com</p>
        ...
        <div className="mt-6 py-6 border-t border-slate-200 text-center">
            <div className="flex flex-wrap justify-center">
                <div className="w-full px-4">
                    ...
                    <button href="" className="px-8 py-2 bg-indigo-400 outline-none border border-indigo-100 rounded text-white font-medium active:scale-95 hover:bg-indigo-600 hover:text-white focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2 
