...
const PlacesMacedonia = () => {
  return (
    <div>
        <div class="py-16 bg-white mb-20">
    <div  class="container m-auto px-6 space-y-8 text-gray-500 md:px-12 lg:px-20">
        <div class="justify-center text-center gap-6 md:text-left md:flex lg:items-center  lg:gap-16">
            <div class="order-last mb-6 space-y-6 md:mb-0 md:w-6/12 lg:w-6/12">
                <h1 class="text-4xl text-gray-800 font-bold md:text-5xl">Best places to visit - 
                <span   class="text-emerald-700">Macedonia</span></h1>
            ...
            <div class="grid grid-cols-5 grid-rows-4 gap-4 md:w-5/12 lg:w-6/12">
                <div class="col-span-2 row-span-4">
                    <img src="https://assets.telegraphindia.com/telegraph/a20f1116-7826-4654-89b9-e8cba21030ec.jpg" class="rounded-full" width="640" height="960" alt="shoes" loading="lazy"></img>
                </div>
                <div class="col-span-2 row-span-2">
                    <img src="https://www.travelanddestinations.com/wp-content/uploads/2019/02/Top-Places-to-Visit-in-Macedonia-Canyon-Matka.jpg" class="w-full h-full object-cover object-top rounded-xl" width="640" height="640" alt="shoe" loading="lazy"></img>
                </div>
                <div class="col-span-3 row-span-3">
                    <img src="https://knowourplanet.com/wp-content/uploads/2022/04/Ohrid.jpg" class="w-full h-full object-cover object-top rounded-xl" width="640" height="427" alt="shoes" loading="lazy"></img>
                </div>
            </div>
        </div>
    </div>
