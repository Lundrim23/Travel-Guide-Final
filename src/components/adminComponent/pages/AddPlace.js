      ...
      <div class="flex w-full lg:w-6/12  bg-white space-y-8 ">
        <div class="w-full px-8 md:px-32 lg:px-24 ">
          <form class="bg-white rounded-md shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-5">
            ...
            <p class="text-sm font-normal text-gray-600 mb-8">Add a place</p>
            ...
            <div class="flex items-center mb-8 py-2 px-3 rounded-2xl relative group">
              <input
                ...
                id="placelocation"
                required
                class="focus:border-emerald-300 w-full h-10 px-4 text-sm peer bg-transparent border-2 rounded-lg outline-none bg-gray-100"
              />
              <label
                for="placelocation"
                class="transform transition-all absolute top-0 left-4 h-full flex items-center pl-3 text-sm text-gray-500 group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-full peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0"
            ...
            <div class="flex items-center mb-8 py-2 px-3 rounded-2xl relative group">
              ...
              /> */}
              <select className="bg-gray-100 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-neutral-800 transition dark:border-neutral-900 dark:text-gray-50 dark:focus:border-teal-500">
              ...
              {/* <label
                for="placeterrain"
                class="transform transition-all absolute top-0 left-20 h-full flex items-center pl-3 text-sm text-gray-500 group-focus-within:text-xs peer-valid:text-xs group-focus-within:h-1/2 peer-valid:h-1/2 group-focus-within:-translate-y-full peer-valid:-translate-y-full group-focus-within:pl-0 peer-valid:pl-0"
              >
                Place terrain
              </label> */}
            </div>
