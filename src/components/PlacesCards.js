...
const PlacesCards = (props) => {
  return (
    ...
    <div class="p-4">
      ...
      <h1 class="text-2xl font-medium text-gray-800 pb-2">{props.PlacesTitle}</h1>
      <p class="text-sm tracking-tight font-light text-slate-400 leading-6">{props.PlacesText}</p>
    </div>
  </div>
    </div>
  )
