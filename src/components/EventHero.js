    ...
    <div class="absolute inset-0  z-30  flex flex-col items-center justify-center">
        ...
        {/* <div class="bg-[url('')]"></div> */}
            <div class="grid grid-cols-12 gap-1">
                <div class="relative my-6 px-8 :flex-growspan-12 sm:col-span-12 md:col-span-7 lg:col-span-7 xxl:col-span-7">
                        ...
                        <div class="p-8">
                            ...
                            <div class="bottom-0 absolute p-2 right-0">
                                <button class="opacity-75 bg-gray-100 hover:bg-pink-900 hover:text-white text-sm font-bold py-2 px-4 rounded inline-flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="mb-2 font-medium leading-tight text-lg w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentflex-growor">
