...
<div class="px-4 py-26 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
 ...
 Get Started
            ...
            <img class=" lg:w-112 h-96 rounded-lg "src="https://imageio.forbes.com/specials-images/imageserve/1157190322/aerial-view-of-beach-and-sea-at-Vrachos-Beach/960x0.jpg?format=jpg&width=960" />
      </div>
    </div>
    ...
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      ...
      <img class="logo lg:w-112 h-96 rounded-lg"src="https://imageio.forbes.com/specials-images/imageserve/1157190322/aerial-view-of-beach-and-sea-at-Vrachos-Beach/960x0.jpg?format=jpg&width=960" />
