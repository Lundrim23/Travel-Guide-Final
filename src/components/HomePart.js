  ...
  return (
    <div>
      <div className="w-full z-50 sticky px-6 bg-gradient-to-b from-white via-slate-500 to-white">
        <div className="px-4 py-26 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
              ...
              {/* <div className="flex items-center space-x-3">
                <a
                  href="/a"
                  className="flex object-cover sm:mr-64 mr-32 object-top items-center text-white  border-2 justify-center w-full sm:px-10 py-4 leading-6 bg-indigo-500 rounded-lg font-black"
                >
                  Get Started
                </a>
              </div> */}
            ...
            <img className=" lg:w-112 h-96 rounded-lg " src={albania} alt="" />
          </div>
        </div>
        ...
        <div className="px-4 py-26 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            ...
            <img className=" lg:w-112 h-96 rounded-lg " src={AlbaniaRiver} alt="" />
          </div>
        </div>
      </div>
    </div>
