...
<div>
    <div class="pt-40 bg-slate-50">
<section class="relative bg-white">
  <img
    class="absolute inset-0 object-[75%] sm:object-[25%] object-cover w-full h-full opacity-75 sm:opacity-75"
  ...
  <div class="hidden sm:block sm:inset-0 sm:absolute sm:bg-gradient-to-b sm:from-slate-50 sm:to-transparent"></div>
  ...
  <div class="relative max-w-screen-xl px-4 py-32 mx-auto lg:h-screen lg:items-center lg:flex">
    <div class="max-w-xl text-center sm:text-left">
      <h1 class="text-3xl font-extrabold sm:text-5xl text-gray-800">
        ...
        <strong class="font-extrabold text-rose-500 sm:block">
          Festivals
        </strong>
      </h1>
      ...
      <div class="flex flex-wrap gap-4 mt-8 text-center">
        <a class="block w-full px-12 py-3 text-sm font-medium text-white rounded shadow bg-rose-600 sm:w-auto active:bg-rose-500 hover:bg-rose-700 focus:outline-none focus:ring" href="#">
          Get Started
        </a>
