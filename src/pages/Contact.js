          ...
          <div className="flex flex-wrap lg:justify-between -mx-4">
            <div className="w-full lg:w-1/2 xl:w-6/12 px-4">
              <div className="max-w-[570px] mb-12 lg:mb-0">
                <span className="block mb-4 text-base text-[#3056D3] font-semibold">
                  Contact Us
                </span>
                <h2
                  className="
                ...
                <div className="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base ">(+383)00 414 257 9980</p>
                  </div>
                </div>
                <div className="flex mb-8 max-w-[370px] w-full">
                  <div
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base ">info@travelguide.com</p>
                    <a
                      href="mailto:starlabstitans@gmail.com"
